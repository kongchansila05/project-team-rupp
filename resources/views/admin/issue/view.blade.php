...
<div class="wrapper">
  ...
  <section class="invoice">
    ...
    <div class="row">
      <div class="col-12">
        <h2 class="page-header">
          ...
          <small class="float-right">Date: {{$issue->created_at}}</small>
        </h2>
      </div>
      <!-- /.col -->
    </div>
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        <address>
          <strong>Warehouse : {{$issue->warehouse_name->name}}</strong><br>
      ...
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
        <b>Reference_no</b> : # {{$issue->reference_no}}<br>
  ...
  <!-- /.content -->
  <a href="/issue/" class="btn btn-danger btn-sm no-print"  > <i class="far fa-file-alt"></i> Back</a>
  <a href="{{ url('issue/view', $issue->id) }}" class="btn btn-info btn-sm no-print"  > <i class="far fa-file-alt"></i>Print </a>
